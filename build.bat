...
python -m PyInstaller --onefile --windowed --name=OracleDBManager --add-data="services;services" --add-data="screens;screens" --add-data="utils;utils" --hidden-import=uuid --hidden-import=cryptography.hazmat.primitives.kdf.pbkdf2 --hidden-import=cryptography.x509 main.py
